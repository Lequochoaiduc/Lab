...
public class MyWordCount {
	...
	public static final String fileName = "res/LOVE.txt";

	private List<String> words = new ArrayList<>();

	public MyWordCount() {
		try {
			this.words.addAll(Utils.loadworld(fileName));
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(mwc.exportWordCountsByOccurence().toArray()));
